...
from app.ingest.climate_nldas import fetch_and_transform_weather
from app.ingest.crop_nass import fetch_and_transform_yield_csv_fallback, fetch_and_transform_yield
...
def main():
    ...
    and yield data into the database.
    """
    ...
    if not api_key:
        print("WARNING: NASS_API_KEY not set. Falling back to CSV for yield data.")
        use_api = False
    else:
        use_api = True
